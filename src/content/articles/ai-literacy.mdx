...
AI is moving faster than anything I've watched since entering the workforce. Someone who got real hands-on experience with it in high school is going to walk into a job differently than someone who opens [Claude](https://claude.ai) for the first time as a new hire. One of them is contributing on week one. The other is catching up.
...
## Mission Bit is launching their [first AI class](https://msnb.io/AI-pilot) this summer
...
And honestly, it shouldn't stop there. [San Francisco is the AI capital of the world](https://www.wired.com/story/the-big-interview-podcast-san-francisco-mayor-daniel-lurie/). [Anthropic](https://anthropic.com), [OpenAI](https://openai.com), the biggest labs anywhere are headquartered here. How do we call ourselves that and not make sure the students growing up here know how to use this stuff? The city, the school district, the companies in our backyard, they should all be asking this question.
